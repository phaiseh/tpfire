---
title: 政府文件與官方記錄
description: 政府公開文件、部門回應、業主立案法團會議記錄、防火通告等官方檔案的存檔
keywords: 政府文件, 官方記錄, 會議記錄, 防火通告, 行政文件, 官方聲明
---

# 政府文件、部門回覆及公開信件

本區塊整理政府部門就宏福苑火災及相關事務的回覆、公開信件、法定命令以及業主立案法團會議記錄。
...
- **屋宇署 (Buildings Department)**
  ...
  - [屋宇署行動 (LM 18-92 BD GRACT11)](LM%2018-92%20BD%20GRACT11.png)
  - [拆卸工程相關 (Removal Works)](Removal%20Works.png)
...
- **[PDF 原件存檔 (PDF Files)](meeting_minutes/pdf/README.md)**：掃描原件，保留文件原貌。
- **[Markdown 文字版 (Markdown Files)](meeting_minutes/markdown/README.md)**：經 OCR 轉錄，方便搜尋及閱讀。
